...
You can trigger the agent via `workflow_dispatch`, or via issue or PR comments using commands like `/co`, `/cogni`, `/review`, or `/test`.
...
`cogni-ai-context7-ops`, `cogni-ai-devops`, `cogni-ai-fact-ops`, `cogni-ai-github-ops`, `cogni-ai-python-dev`, `cogni-ai-tester`, `cogni-ai-code-reviewer`, and `cogni-ai-plan-reviewer` are configured with `mode: all`, so
...
| `mentions`         | Comma-separated mentions    | `/co,/cogni,/review,/test` | No       |
